...
<?php include_once "php/includes/header.php"; ?>
    ...
    <div class="container mb-4">
        <div class="jumbotron my-4 d-flex align-items-center" style="background: url(img/Logo.jpeg) no-repeat"></div>
            <h4 class="text-center text-secondary mb-4"> Por que aplicar Metodologias Ativas ?</h4>
            <div class="row d-flex flex-wrap" id="container-historia">
                ...
                e o aprendizado não acontece sem ela. O aluno não fica sentado ouvindo e anotando, ele debate, critica, faz. Ele ajuda a construir o conhecimento junto com 
                o professor e com os colegas.</p>
                <p> &numsp; &numsp; A forma como o aprendizado é processado pelo cérebro se altera completamente dessa maneira. Conforme a pirâmide do aprendizado de 
